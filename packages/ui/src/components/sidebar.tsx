...
import {
	...
	SheetHeader,
	SheetTitle,
} from "@flowlog/ui/components/sheet";
...
import { useIsMobile } from "@flowlog/ui/hooks/use-mobile";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: vendored shadcn sidebar persistence
