...
export const PAIRING_REQUEST_STATUS = {
	PENDING: "PENDING",
	APPROVED: "APPROVED",
	CLAIMED: "CLAIMED",
} as const;
...
export type PairingRequestStatus =
	(typeof PAIRING_REQUEST_STATUS)[keyof typeof PAIRING_REQUEST_STATUS];

export const PAIRING_REQUEST_STATUS_VALUES = [
	PAIRING_REQUEST_STATUS.PENDING,
	PAIRING_REQUEST_STATUS.APPROVED,
	PAIRING_REQUEST_STATUS.CLAIMED,
] as const;
